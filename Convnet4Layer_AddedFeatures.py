...
def main():
    ...
    result_dir = './results4/' # directory where the results from the training are saved
    ...
    accuracy = accuracy_summaries(softmax_output=y_conv, correct_class=y_,name='Results')
